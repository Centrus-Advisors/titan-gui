	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'padding-bottom', _1: '200px'},
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('card-box'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
										...
										},
										{
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('fa fa-download'),
														_1: {ctor: '[]'}
													},
													{ctor: '[]'}),
												_1: {ctor: '[]'}
...
var _user$project$DownloadForm_State$initialDbDate = function (todayDate) {
...
var _user$project$DownloadForm_State$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
...
var _user$project$DownloadForm$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$DownloadForm_State$init, view: _user$project$DownloadForm_View$root, update: _user$project$DownloadForm_State$update, subscriptions: _user$project$DownloadForm_State$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (todayDate) {
...
var Elm = {};
Elm['DownloadForm'] = Elm['DownloadForm'] || {};
if (typeof _user$project$DownloadForm$main !== 'undefined') {
    _user$project$DownloadForm$main(Elm['DownloadForm'], 'DownloadForm', undefined);
}
